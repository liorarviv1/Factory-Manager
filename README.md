# Factory Manager
 ...
 An management application with login authentication , list of employees and employee search, departments and shifts
 - developed using ASP.NET, EntityFramework and MySQL.
